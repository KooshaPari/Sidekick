# AGENTS.md — cheap-llm-mcp

This file governs work inside the cheap-llm-mcp repository.

## Identity

cheap-llm-mcp is a .

Do not apply parent shelf instructions (`/Users/kooshapari/CodeProjects/Phenotype/repos/AGENTS.md`) unless explicitly referenced. Work from this directory and treat paths as local to cheap-llm-mcp.
